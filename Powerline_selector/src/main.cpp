...
int main(int argc, char* argv[]){
    ...
    ros::Subscriber powerline_sub = nh.subscribe("/Estimator/lines3d",1,powerline_handler);
    powerline_position_pub = nh.advertise<inspec_msg::line_control_info>("/onboard/setpoint/inspectionPoints",1);
